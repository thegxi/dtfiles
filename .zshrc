...
export MAVEN_HOME=/opt/apache/apache-maven-3.6.3
export PATH=$HOME/bin:/usr/local/bin:$JAVA_HOME/bin:$NODE_PATH/bin:$MAVEN_HOME/bin:$PATH
...
# default open tmux on the terminal
...
alias j11="export JAVA_HOME=/Library/Java/JavaVirtualMachines/jdk-11.0.13.jdk/Contents/Home"
alias lg="lazygit"
alias mp="mpc play"
alias ms="mpc stop"
alias mpr="mpc prev"
alias mpn="mpc next"
alias mro="mpc repeat on"
alias mso="mpc single on"
alias mav="mpc volume +20"
